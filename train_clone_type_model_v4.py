...
Uso basico:
    python train_clone_type_model_v7.py --csv "results/cheating_dataset_results.csv"

Comparar modelos:
    python train_clone_type_model_v7.py --csv "results/cheating_dataset_results.csv" --compare
...
Notas:
    ...
    - Los clone_type 0 y 4 se convierten internamente a 3.
...
def load_dataset(csv_path: str | Path) -> Tuple[pd.DataFrame, pd.Series, pd.DataFrame]:
    ...
    # Objetivo original y mapeado para entrenamiento.
    ...
    y = y_original.astype(int).replace({0: 3, 4: 3})
...
def evaluate_model(
    ...
    print("Distribucion de clone_type despues de mapear 0 y 4 a 3:")
